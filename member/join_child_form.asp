    ...
    <div class="contents">
        <div class="detail-login">
			...
			<table style="margin-top:30px;">
			    ...
			    <tr>
                    <th><label for="cname" class="nameLa">이름</label></th>
				    <td><input type="text" id="cname" class="name" name="cname" /></td>
                </tr>
            	<tr>
                    ...
                    <td>
                        ...
                        <!-- 아래가 기존 소스인데 이부분은 변경이 필요해서 일단 주석처리해놓았습니다. -->
                ...
                <tr>
                    <th><label for="parent_name" class="parent_nameLa">보호자 이름</label></th>
                    <td>
                ...
                <tr>
                    <th><label for="parent_sex" class="nameLa">보호자 성별</label></th>
                    <td><input type="text" id="parent_sex" class="parent_sex" name="parent_sex" placeholder="남" value="<%=strgender%>" /></td>
                </tr>
                <tr>
                    <th rowspan="2"><label for="parent_birth_date_01">보호자 생년월일</label></th>
                    <td>
                        <div class="select_box birth_date_box">
                            <div class="select">
