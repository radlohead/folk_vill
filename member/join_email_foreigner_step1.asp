                ...
                <tr>
                    ...
                    <td>
                        <div class="email_box">
                            ...
                            <input type="text" id="email2" name="email2" placeholder="이메일 주소" style="ime-mode:disabled" class="email_02 hidden" />
                            <!--
...
<iframe name="blank_frame" src="about:blank" width="0" height="0" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" hspace="0" vspace="0" style="border:0px solid #000;" title="이메일인증외국인회원가입아이프레임"></iframe>