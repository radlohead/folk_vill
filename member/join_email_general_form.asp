        ...
        <div class="detail-login">
			...
			<input type="hidden" name="name" value="<%=sName%>">
				...
				<span class="check_box_wrap">
                    <input type="radio" name="gender" id="gender_type_01" class="solar" value="1" checked><label for="solar" class="solarLa"></label>
                ...
                <div class="address_wrap">
                    ...
                    <input type="text" name="address_detail" id="address_detail" maxlength="50" class="add_03" placeholder="상세주소" />&nbsp; (* Daum Kakao Corp. 제공)
                </div>
