...
<%
	If session("id") = "" Then
		...
		Response.write " parent.location.href='/member/login.asp?RtnURL=/mypage/qna_list.asp';"
	...
	'#######################################################	
	'# TBL_INQUIRY TABLE Delete START
	'#######################################################
	...
	With objCmd
		...
		.CommandText = "SP_HUGO7_TBL_INQUIRY_MEMBER_DELETE"
	...
	Else
		...
		Call CloseDbConnection()
		Response.Write ("<script language='javascript'>")
		Response.Write ("location.href='/mobile/mypage/qna_list.asp';")
		Response.Write ("</script>")
		Response.End
	End If	
%>