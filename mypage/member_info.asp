    ...
    <div class="contents">
        <div class="detail-login">
			...
			%>
			    ...
			    <tr>
                    <th><label for="name" class="nameLa">이름</label></th>
                    <td><input type="text" id="name" class="name" name="name" readonly value="<%=name%>" /></td>
				</tr>
				<tr>
                    <th><label for="name" class="nameLa">성별</label></th>
			...
			%>
                ...
                <tr>
                    ...
                    <td><input type="text" id="id" class="id" name="id" value="<%=id%>" readonly="readonly" /></td>
                </tr>
                <tr>
                    <th><label for="add_01">주소</label></th>
                    <td>
                        <div class="address_wrap">
                            <span class="add_01_box">
                                <input type="text" name="zipcode1" id="zipcode1" class="zipcode1" readonly="readonly" />
                                <input type="text" name="zipcode2" id="zipcode2" class="zipcode2" readonly="readonly" />
                            ...
                            <input type="text" name="address_detail" id="address_detail" maxlength="50" class="add_03 mb5" placeholder="상세주소" />
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th rowspan="2"><label for="phone">휴대폰 번호</label></th>
                    <td class="bd0">
                    <div class="select_box mt5">
                    <div class="phone-select">
				<%
					If gubun = "C" Then
				%>
                        ...
                        <input type="text" name="pmobile2" id="pmobile2" maxlength="8" class="phone_02" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'');" onkeypress="txtOnlyNum(event)" />
				<%
					Else
				%>
                        ...
                        <input type="text" name="mobile2" id="mobile2" maxlength="8" class="phone_02" onKeyUp="this.value=this.value.replace(/[^0-9]/g,'');" onkeypress="txtOnlyNum(event)" />
				<%
					End If
				%>
