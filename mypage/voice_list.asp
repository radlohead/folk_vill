...
<%
	If session("id") = "" Then
		...
		Response.write " location.href='/mobile/member/login.asp?RtnURL=/mobile/mypage/voice_list.asp';"
		Response.write "</script>"
		Response.End
	End If

	Dim filename : filename = "voice_list.asp"
			...
			success: function(result_data){
				...
				if (flag == "error") {
					...
					$(result_data).find("item").each(function() {
						...
						var code_name	= $.trim($(this).find("code_name").text());
						...
						if (code_name = "칭찬"){
							media_add += "		<span class='icon_text'><img src='/mobile/images/mypage/compliment_icon.png' alt='칭찬' /></span>";
						}else if (code_name = "신고"){
							media_add += "		<span class='icon_text'><img src='/mobile/images/mypage/inconvenient_icon.png' alt='신고' /></span>";
						}else{
							media_add += "		<span class='icon_text'><img src='/mobile/images/mypage/suggest_icon.png' alt='제안' /></span>";
						}
						...
						media_add += "    </td>";
						media_add += "    <td>";
						media_add += "        <a href='voice_view.asp?seq=" + seq + "&pg=" + pg + "' class='icon icon_more'>자세히보기</a>";
						media_add += "    </td>";
						media_add += "</tr>";
            ...
            <div class="content">
				...
				%>
                    <tr>
                        ...
                        <td>
                            <a href="voice_view.asp?seq=<%=seq%>&pg=<%=pg%>" class="icon icon_more">자세히보기</a>
                        </td>
                    </tr>
				<%
					Next
