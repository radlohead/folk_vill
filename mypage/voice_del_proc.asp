...
<%
	If session("id") = "" Then
		...
		Response.write " parent.location.href='/mobile/member/login.asp?RtnURL=/mobile/mypage/voice_list.asp';"
	...
	If uid <> session("id") Then
		Response.write "<script language='javascript'>"
		Response.write " alert('본인이 작성한 글만 삭제할 수 있습니다.');"
	...
	With objCmd
		...
		.CommandText = "SP_HUGO7_TBL_VOICE_MEMBER_DELETE"
	...
	Else
		...
		Call CloseDbConnection()
		Response.Write ("<script language='javascript'>")
		Response.Write ("location.href='/mobile/mypage/voice_list.asp';")
		Response.Write ("</script>")
		Response.End
	End If	
%>