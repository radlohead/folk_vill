...
'	Response.End
	...
	With objCmd
		...
		.ActiveConnection = Conn
		.CommandText = "SP_HUGO7_TBL_MEMBER_UPDATE"
		.CommandType = adCmdStoredProc
		'기본정보
	...
	Else
		...
		Call CloseDbConnection() '데이터베이스 클로즈
		Response.Write "<script language='javascript'>"
		'Response.Write " alert('회원정보가 수정되었습니다.');"
		Response.Write " parent.location.href='/mobile/mypage/member_modify.asp';"
		Response.Write "</script>"
		Response.End
	End If
%>