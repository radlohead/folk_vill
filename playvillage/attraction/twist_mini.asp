...
<!-- 슬라이드 -->
            <div class="attr-slide swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="/mobile/images/play_village/twist_mini/twist_mini_slide01.jpg" alt="" /></div>
                    <div class="swiper-slide"><img src="/mobile/images/play_village/twist_mini/twist_mini_slide02.jpg" alt="" /></div>
                    <div class="swiper-slide"><img src="/mobile/images/play_village/twist_mini/twist_mini_slide03.jpg" alt="" /></div>
                </div>
                <!-- Add Pagination -->
            ...
            <span class="explain_text">아이들도 즐길 수 있는 짜릿한 고공낙하!<br/>
                                       트위스트 미니!
            </span>
            <dl class="infor">
                <dt>이용요금</dt>
