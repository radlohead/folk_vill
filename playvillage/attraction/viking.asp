...
<!-- 슬라이드 -->
            <div class="attr-slide swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="/mobile/images/play_village/viking/viking_slide01.jpg" alt="" /></div>
                </div>
                <!-- Add Pagination -->
            ...
            <span class="explain_text">거대한 해적선이 하늘을 가르며 날아간다!<br/>
                                       아슬아슬한 재미와 함께 짜릿한 스릴을 선사합니다
            </span>
            <dl class="infor">
                <dt>이용요금</dt>
                <dd>
