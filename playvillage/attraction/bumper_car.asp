...
<!-- 슬라이드 -->
            <div class="attr-slide swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="/mobile/images/play_village/bumper_car/bumper_car_slide01.jpg" alt="" /></div>
                    <div class="swiper-slide"><img src="/mobile/images/play_village/bumper_car/bumper_car_slide02.jpg" alt="" /></div>
                </div>
                <!-- Add Pagination -->
            ...
            <span class="explain_text">이리 쿵! 저리 쿵! 시간 가는 줄 모르는 <br/>
                                       신나는 드라이빙~<br/>
                                       바람을 가르는 범퍼카를 타고 스릴을 만끽하세요!
            </span>
            <dl class="infor">
                <dt>이용요금</dt>
                <dd>
                ...
                <dd>
                    ...
                    <div class="text-box02">
                        <span class="text">신장 120cm 이상</span>
                    </div>
                </dd>
            </dl>
        </div>
