...
<!-- 슬라이드 -->
            <div class="attr-slide swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="/mobile/images/play_village/wooden_horse/wooden_horse_slide01.jpg" alt="" /></div>
                    <div class="swiper-slide"><img src="/mobile/images/play_village/wooden_horse/wooden_horse_slide02.jpg" alt="" /></div>
                    <div class="swiper-slide"><img src="/mobile/images/play_village/wooden_horse/wooden_horse_slide03.jpg" alt="" /></div>
                </div>
                <!-- Add Pagination -->
            ...
            <span class="explain_text">아름다운 동요과 함께 동심으로 출발~<br/>
                                       말을 탄 왕자와 공주가 되어 보세요~
            </span>
            <dl class="infor">
                <dt>이용요금</dt>
