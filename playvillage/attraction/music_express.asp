...
<!-- 슬라이드 -->
            <div class="attr-slide swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="/mobile/images/play_village/music_express/music_express_slide01.jpg" alt="" /></div>
                </div>
                <!-- Add Pagination -->
            ...
            <span class="explain_text">신나는 음악과 함께 빙글빙글 돌아가는 세상~<br/>
                                       앞으로 한번, 뒤로 한번 운행하기에 어지럽지 않아요!
            </span>
            <dl class="infor">
                <dt>이용요금</dt>
                <dd>
