        ...
        <div class="detail-member">
            ...
            <div class="detail-content buy_eat">
                <span class="photo-img map">
                    <a href="#none" class="map-btn map-btn_11">지도보기</a>
                    <img src="/mobile/images/play_village/eat/pizza/pizza_titleImg.jpg" alt="임실치즈피자 사진" />
                </span>
                <span class="text01">
                    온 가족이 즐기는 임실치즈피자!<br/>
                    고소한 치즈가 듬뿍 들어간 임실치즈피자를 즐겨보세요. 여러가지 신선한 재료로 세상에 단 하나뿐인 나만의 피자도 만들 수 있습니다.
                </span>
            </div>
        </div>
    </div>
