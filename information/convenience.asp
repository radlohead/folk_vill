                                ...
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">모유수유실, 기저귀교환대, 전자레인지 구비</span>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">놀이마을 전설의고향 맞은편</span>
                                            </p>
                                        </li>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">응급치료 약품 및 자동 제세동기(AED) 구비</span>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">의무실 안내데스크에서 대여 가능(선착순)</span>
                                            </p>
                                        </li>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">장애인 관람객 우선 대여</span>
                                            </p>
                                        </li>
                                        <li class="join-method-p">
                                            <p>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">의무실 안내데스크에서 안내</span>
                                            </p>
                                        </li>
                                        <li class="join-method-p">
                                            <p>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">유아휴게실 외부</span>
                                            </p>
                                        </li>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">놀이마을 미니바이킹 주변</span>
                                            </p>
                                        </li>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">대(3,000원), 중(2,000원), 소(1,000원)</span>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">정문(대관문) 입장 전 좌측</span>
                                            </p>
                                        </li>
                                        <li class="join-method-p">
                                            <p>
                                                <span class="icon02"></span>
                                                <span style="line-height:1.3em;">내외국인 관람객 홍보자료 제공</span>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
