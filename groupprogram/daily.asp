            ...
            <div class="detail-content daily">
                ...
                <div class="main-tab daily-tab">
                    ...
                    <div class="tab-content tabMenu1">
                        ...
                        <section class="text_box">
                            <h4>예약문의</h4>
                            <span class="text">031-288-4000~1, 4004~5</span>
                        </section>
                    ...
                    <div class="tab-content tabMenu2">
                        <section class="text_box">
                            <h4>대상</h4>
                            <span class="text">기업&외국인단체 성인 20명 이상</span>
                        </section>
                        <section class="text_box">
                            <h4>예약문의</h4>
                            <span class="text">031-288-1709, 1710</span>
                        </section>
                        <table class="course mt20">
                            <caption>일반코스에 대한 안내</caption>
                            <colgroup>
                                <col width="25%" />
                                <col width="25%" />
                                <col width="50%" />
                        ...
                        <p>
                            ...
                            <span>체험은 날씨 및 내부사정에 의해 변경될 수 있습니다</span>
                        </p>
                        <div class="group_program_img">
                            <a href="#none" class="img imgLeft"><img src="/mobile/images/groupprogram/group_pic_01.jpg" alt="" /></a>
                            <a href="#none" class="img imgRight"><img src="/mobile/images/groupprogram/group_pic_02.jpg" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
