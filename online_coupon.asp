...
%>
			...
			<div class="tab-content tabMenu2">
				...
				%>
					<div class="swiper-slide"><a href='/mobile/information/coupon_list.asp'><img src="<%=FileURL%><%=files1%>" alt="<%=alt1%>" /></a><img src="/mobile/images/index/main-tab2_img01.jpg" alt="" /></div>
				<%
						Next
					Else
					End If
